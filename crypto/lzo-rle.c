 ...
 * Structure identical to this tree's crypto/lzo.c (scomp API already
 * present), so taken verbatim -- only the underlying lib call differs
 * (lzorle1x_1_compress instead of lzo1x_1_compress).
 */
