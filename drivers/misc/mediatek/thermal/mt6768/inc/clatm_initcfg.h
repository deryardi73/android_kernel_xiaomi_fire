...
#define CLATM_INIT_CFG_2_TARGET_TJ		(88000)
#define CLATM_INIT_CFG_2_EXIT_POINT		(3000)
#define CLATM_INIT_CFG_2_FIRST_STEP		(4700)
#define CLATM_INIT_CFG_2_THETA_RISE		(2)
#define CLATM_INIT_CFG_2_THETA_FALL		(4)
#define CLATM_INIT_CFG_2_MIN_BUDGET_CHG		(1)
#define CLATM_INIT_CFG_2_MIN_CPU_PWR		(600)
#define CLATM_INIT_CFG_2_MAX_CPU_PWR		(4700)
#define CLATM_INIT_CFG_2_MIN_GPU_PWR		(800)
#define CLATM_INIT_CFG_2_MAX_GPU_PWR		(2500)

#define CLATM_INIT_CFG_ACTIVE_ATM_COOLER	(0)

#define CLATM_INIT_CFG_CATM			(2)

#define CLATM_INIT_CFG_PHPB_CPU_TT		(6)
#define CLATM_INIT_CFG_PHPB_CPU_TP		(6)

#define CLATM_INIT_CFG_PHPB_GPU_TT		(35)
#define CLATM_INIT_CFG_PHPB_GPU_TP		(35)
...
#define CLCTM_TPCB_1				(50000)
#define CLCTM_TPCB_2				(54000)
