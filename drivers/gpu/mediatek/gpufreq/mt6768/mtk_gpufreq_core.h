 ...
 **************************************************/
#define SEG_GPU_DVFS_FREQ0			(1600000)	/* KHz */
#define SEG_GPU_DVFS_FREQ1			(1450000)	/* KHz */
#define SEG_GPU_DVFS_FREQ2			(1300000)	/* KHz */
#define SEG_GPU_DVFS_FREQ3			(1150000)	/* KHz */
...
#define SEG_GPU_DVFS_VOLT0		(118625)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT1		(107625)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(101250)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT3		(93750)		/* mV x 100 */
...
#define SEG_GPU_DVFS_VSRAM0		(128625)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM1		(117625)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(111250)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM3		(103750)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM4		(100000)	/* mV x 100 */
