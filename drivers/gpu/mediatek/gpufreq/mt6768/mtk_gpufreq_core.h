 ...
 **************************************************/
#define SEG_GPU_DVFS_FREQ0			(2000000)	/* KHz */
#define SEG_GPU_DVFS_FREQ1			(1800000)	/* KHz */
#define SEG_GPU_DVFS_FREQ2			(1600000)	/* KHz */
#define SEG_GPU_DVFS_FREQ3			(1400000)	/* KHz */
#define SEG_GPU_DVFS_FREQ4			(1200000)	/* KHz */
#define SEG_GPU_DVFS_FREQ5			(1000000)	/* KHz */
...
#define SEG_GPU_DVFS_VOLT1		(118000)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(115000)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT3		(110000)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT4		(102000)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT5		(87500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT6		(85000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT7		(82500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT8		(80000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT9		(77500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT10		(75000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT11		(74375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT12		(73125)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT13		(71875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT14		(70625)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT15		(70000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT16		(68750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT17		(67500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT18		(66250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT19		(65625)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT20		(65000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT21		(64375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT22		(63750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT23		(63125)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT24		(61875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT25		(61250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT26		(60625)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT27		(60000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT28		(59375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT29		(58125)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT30		(56875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT31		(56250)		/* mV x 100 */

#define SEG_GPU_DVFS_VSRAM0		(130000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM1		(128000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(125000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM3		(120000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM4		(112000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM5		(97500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM6		(95000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM7		(92500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM8		(90000)		/* mV x 100 */
