 ...
 **************************************************/
#define SEG_GPU_DVFS_FREQ0			(1225000)	/* KHz */
#define SEG_GPU_DVFS_FREQ1			(1150000)	/* KHz */
#define SEG_GPU_DVFS_FREQ2			(1075000)	/* KHz */
...
#define SEG_GPU_DVFS_VOLT0		(116375)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT1		(109250)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(102125)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT3		(95000)		/* mV x 100 */
...
#define SEG_GPU_DVFS_VSRAM0		(126375)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM1		(119250)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(112125)	/* mV x 100 */
